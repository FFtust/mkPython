...
class gamepad_c():
    ...
    def is_key_pressed(button):
        return self.adapter.process.get_value("be164aab76187dac8929539641ffd163", (button))
    def get_joystick(joystick_pos):
        return self.adapter.process.get_value("b3da5fe046d5548d0d6d4353db512086", (joystick_pos))
    def get_all():
        return self.adapter.process.get_value("0d9e44971cb6c3435bf9be6823bab93c", ())
